...
public class HatchingGui {
    ...
    public static void registerEntityRenders(RegisterGuiOverlaysEvent event) {
        event.registerAboveAll("hatch", HatchingGui.HATCH_OVERLAY);
    }
    ...
    private static void renderHatchingData(GuiGraphics guiGraphics, EggBlockEntity eggBlockEntity){
        ...
        String ownerName = "Owned by: " + minecraft.level.getPlayerByUUID(eggBlockEntity.getOwnerUUID()).getName().getString();
