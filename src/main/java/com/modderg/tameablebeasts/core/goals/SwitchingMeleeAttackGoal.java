...
public class SwitchingMeleeAttackGoal extends Goal {
    ...
    public SwitchingMeleeAttackGoal(PathfinderMob p_25552_, double p_25553_, boolean p_25554_) {
        this.mob = p_25552_;
    ...
    public boolean canUse() {
        long i = this.mob.getLevel().getGameTime();
