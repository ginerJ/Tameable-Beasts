...
public class SwitchingFollowOwnerGoal extends Goal {
    ...
    public SwitchingFollowOwnerGoal(TamableAnimal p_25294_, double p_25295_, float p_25296_, float p_25297_, boolean p_25298_) {
        this.tamable = p_25294_;
        this.level = p_25294_.getLevel();
