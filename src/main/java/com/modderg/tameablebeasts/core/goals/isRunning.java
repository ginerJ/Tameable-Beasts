...
public class isRunning extends Goal {
    public static final int WATER_CHECK_DISTANCE_VERTICAL = 1;
    protected final TameableGAnimal mob;
    protected final double speedModifier;
    protected double posX;
    protected double posY;
    protected double posZ;

    public isRunning(TameableGAnimal p_25691_, double p_25692_) {
        this.mob = p_25691_;
    ...
    public boolean canUse() {
        if (!this.shouldPanic()) {
            ...
            if (this.mob.isOnFire()) {
                BlockPos blockpos = this.lookForWater(this.mob.getLevel(), this.mob, 5);
                if (blockpos != null) {
