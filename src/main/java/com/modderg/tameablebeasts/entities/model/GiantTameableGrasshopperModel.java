...
public class GiantTameableGrasshopperModel extends GeoModel<GrasshopperEntity> {
    ...
    private final ResourceLocation[][] textures = {
            new ResourceLocation[] {
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper.png"),
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper2.png"),
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper3.png")
            },
            new ResourceLocation[] {
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper_saddled.png"),
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper2_saddled.png"),
                    new ResourceLocation(TameableBeast.MOD_ID, "textures/entity/giant_grasshopper3_saddled.png")
            }
    };
