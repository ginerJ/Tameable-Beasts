...
public class ScarecrowAllayModel extends GeoModel<ScarecrowAllayEntity> {
    ...
    @Override
    public void addAdditionalStateData(ScarecrowAllayEntity animatable, long instanceId, BiConsumer<DataTicket<ScarecrowAllayEntity>, ScarecrowAllayEntity> dataConsumer) {
        CoreGeoBone head = getAnimationProcessor().getBone("head");

        if (head != null) {
            EntityModelData entityData = animatable.getEntityData();
