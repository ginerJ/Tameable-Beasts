...
public class ChikoteModel extends TBGeoModel<ChikoteEntity> {
    ...
    public ResourceLocation getModelResource(ChikoteEntity entity) {
        if(!entity.isBaby())
            return new ResourceLocation(TameableBeasts.MOD_ID, "geo/chikote.geo.json");
        return new ResourceLocation(TameableBeasts.MOD_ID, "geo/chikote_baby.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ChikoteEntity entity) {
        return new ResourceLocation(TameableBeasts.MOD_ID, "textures/entity/chikote"+ entity.getTextureID() +".png");
    }
