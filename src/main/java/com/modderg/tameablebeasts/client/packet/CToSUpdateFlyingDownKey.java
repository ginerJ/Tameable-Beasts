...
public class CToSUpdateFlyingDownKey {

    private final int uuid;
    private final boolean value;


    public CToSUpdateFlyingDownKey(int uuid, boolean value) {
        this.uuid = uuid;
        this.value = value;
    }

    public CToSUpdateFlyingDownKey(FriendlyByteBuf buffer) {
